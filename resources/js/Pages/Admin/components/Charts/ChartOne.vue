...
<template>
  <div
    class="col-span-12 rounded-lg border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default  sm:px-7.5 xl:col-span-"
  >
    <div class="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
      <div class="flex w-full flex-wrap gap-3 sm:gap-5 pt-4">
        <div class="flex min-w-47.5">
          ...
          <div class="w-full">
            <p class="font-semibold text-primary text-blue-600">Total Vacation Leave</p>
        ...
        <div class="flex min-w-47.5">
          ...
          <div class="w-full">
            <p class="font-semibold text-secondary">Total Sick Leave</p>
            <p class="text-sm font-medium">12.04.2022 - 12.05.2022</p>
          </div>
        </div>
      </div>
