    ...
    <header class="bg-white">
      <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
          ...
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">PDS</a>
          <Dropdown align="left" width="48">
            <template #trigger>
              <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Leave</a>
            </template>
            <template #content>
              <DropdownLink href="#">Leave Application</DropdownLink>
              <DropdownLink href="#">Privileges and Forced Leaves</DropdownLink>
              <DropdownLink href="#">Leave Index Card</DropdownLink> 
            </template>
          </Dropdown>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Payslip</a>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Attendance</a>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">DTR</a>
        </div>
