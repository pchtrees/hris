<template>
  <div class="flex h-screen">
    <AdminLayout>
      <template #header>
        <h1 class="text-2xl font-bold m-4 text-gray-600">Employees</h1>
        ...
        <table class="w-full table-auto">
          <thead>
            <tr class="bg-gray-200 text-left">
              ...
              <th class="min-w-[150px] py-4 px-4 font-medium text-black">Office</th>
              <th class="min-w-[150px] py-4 px-4 font-medium text-black">Contact</th>
          ...
          <tbody>
            <tr v-for="employee in employees" :key="employee.id" class="hover:bg-gray-100">
              <td class="py-5 px-4 pl-9 xl:pl-11 text-left">
                <h5 class="font-medium text-black">{{ employee.fname }} {{ employee.lname }}</h5>
              </td>
              <td class="py-5 px-4">{{ officeNames[employee.office_id] }}</td>

              <td class="py-5 px-4">{{ employee.mob_no }}</td>
              <td class="py-5 px-4"> 
                <p class="inline-flex rounded-full bg-opacity-10 py-1 px-3 text-sm font-medium":class="{ 'text-green-700': employee.is_active, 'text-red-500': !employee.is_active }">
