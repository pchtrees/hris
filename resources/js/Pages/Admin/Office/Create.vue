<template>
  <div class="flex h-screen">
    <AdminLayout>
      <template #header>
        <h1 class="text-2xl font-bold m-4 text-gray-600">Office</h1>
        ...
        <table class="w-full table-auto">
          <thead>
            <tr class="bg-gray-200 text-left">
              <th class="min-w-[220px] py-4 px-4 font-medium text-black xl:pl-11">Office</th>
          ...
          <tbody>
            <tr v-for="office in offices" :key="office.id" class="hover:bg-gray-100">
              <td class="py-5 px-4 pl-9 xl:pl-11 text-left">
                <h5 class="font-medium text-black">{{ office.name }}</h5>
              </td>
              <td class="py-5 px-4" >{{ officeName }}</td>
              <td class="py-5 px-4"> 
