<template>
  <div class="col-span-12 rounded-lg border border-stroke dark:border-none bg-white dark:bg-boxdark dark:text-stroke px-5 pt-5 pb-5 shadow-default sm:px-7.5 xl:col-span-8">
    <div class="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
      <div class="flex w-full flex-wrap gap-3 sm:gap-5">
        <div class="flex min-w-47.5">
          ...
          <div class="w-full">
            <p class="font-semibold text-primary">Total Plantilla</p>
        ...
        <div class="flex min-w-47.5">
          ...
          <div class="w-full">
            <p class="font-semibold text-secondary">Total Non-Plantilla</p>
            <p class="text-sm font-medium">{{ formattedDate }}</p>
          </div>
        </div>
      </div>
